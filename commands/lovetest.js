...
const { get } = require("snekfetch");
 ...
 module.exports.run = async (bot, message, args) => {
    ...
    const data = await get(`https://love-calculator.p.mashape.com/getPercentage?fname=${message.member.displayName}&sname=${message.mentions.members.first().displayName}`).set("X-Mashape-Key", process.env.TYPICAL);
